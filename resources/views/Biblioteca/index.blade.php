...
<head> 
    ...
    <div style="color:black; width:auto; height: auto; text-align:center; " >
     ...
     <li class="nav-item" role="presentation"> 
       <a  href = "/Biblioteca/showLibrosPrestados"> <button class="nav-link active rounded-2"  id= "btnlibros"  name="btnlibros" data-bs-toggle="tab" type="summit" role="tab" aria-selected="true">LIBROS ALQUILADOS</button> 
  
 </li> 
   <li class="nav nav-pills nav-fill gap-2 p-1 small bg-primary rounded-0 shadow-sm" role="presentation"> 
    <a href="/Biblioteca/show">  
      <button class="nav-link active rounded-2" id="btnalquiler" name="btnalquiler"
